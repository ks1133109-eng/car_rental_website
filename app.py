    ...
    if not Car.query.first():
        cars = [
            Car(
                ...
                type="Sedan",
                price=50,
                image_url="https://images.unsplash.com/photo-1617788138017-80ad40651399?w=500"
            ),
            Car(
                name="Ford Mustang",
                type="Sport",
                price=120,
                image_url="https://images.unsplash.com/photo-1580273916550-e323be2ebcc5?w=500"
            ),
            Car(
                name="Jeep Wrangler",
                type="SUV",
