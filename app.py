...
class Car(db.Model):
    ...
    category = db.Column(db.String(50)) # Hatchback, Sedan, SUV
    price_per_hr = db.Column(db.Integer, nullable=False)
    image_url = db.Column(db.String(500), nullable=False)
    transmission = db.Column(db.String(20)) # Manual/Auto
    fuel_type = db.Column(db.String(20))    # Petrol/Diesel/EV
...
def book_car(car_id):
    ...
    if request.method == 'POST':
        ...
        new_booking = Booking(user_id=current_user.id, car_id=car.id, total_cost=car.price_per_hr * 24)
